(function ($) {
    $.idleHands = function (userSettings) {
        ...
        let createDialog = function () {
            let dialogTimer = '';
            if (settings.showDialogTimer) {
                dialogTimer = '<p id="jquery-idle-hands-time-remaining-label">' + (settings.dialogTimeRemainingLabel + ': ') +
        ...
        let showDialog = function () {
            ...
            flashingTitle = setTimeout(flashTitle, 2000, originalPageTitle, settings.documentTitle);
